...
%SetSASoptions;
%ExecTimeStart;
%ODSOutputOpen(&odspath, &odsfile, odsfiletype=&odsfiletype, macro=PLOTSURVIVAL, log=&log);
...
%do i = 1 %to &nro_varclass;
	...
	ods graphics / outputfmt=png imagename="&imagerootname-&target-&k-&_var_" reset=index;	%* This generates the image file with the name specified in the IMAGENAME= option;
