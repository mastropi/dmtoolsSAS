...
Created: 		29-Jul-2015
Modified: 		20-Sep-2015 (previous: 29-Jul-2015)
SAS Version:	9.4
...
%PHTestPlots(
	...
	imagerootname=PHTestPlot,	*** Root name to be used for the image file name generated by ODS graphics.
...
- imagerootname:Root name to be used for the image file name generated by ODS graphics.
				...
				in the order they are passed to the VARCLASS= and VARNUM= parameters, starting with
				the variables listed in VARCLASS=.
				default: PHTestPlot
...
%MACRO ShowMacroCall;
	...
	%put imagerootname=PHTestPlot , %quote(*** Root name to be used for the image file name generated by ODS graphics.);
...
%if &log %then %do;
	...
	%put PHTESTPLOTS: - imagerootname = %quote(&imagerootname);
...
%do i = 1 %to &nro_varclass;
	...
	ods graphics / imagename="&imagerootname-&target-&k-&_var_" reset=index;	%* This generates the image file with the name specified in the IMAGENAME= option;
