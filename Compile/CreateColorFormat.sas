...
*/
&rsubmit;
%MACRO CreateColorFormat(data, var, by, fmtname, stat=mean, library=WORK, out=, log=1, help=0) / store des="Creates a color ramp format based on a range of variable values";
/*
TODO:
