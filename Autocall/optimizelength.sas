...
- %SetSASOptions
*/
%MACRO OptimizeLength(data, var=_ALL_, apply=0, out=_OptimizeLength_, macrovar=lengthstr, print=1, log=1) / des="Optimizes the length of integer variables based on their value range";
%local var4len;
%local len4len;
